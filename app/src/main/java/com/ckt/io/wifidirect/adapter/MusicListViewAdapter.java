...
public class MusicListViewAdapter extends BaseAdapter {
    ...
    public MusicListViewAdapter() {
        super();
    }

    public MusicListViewAdapter(Context context, ArrayList<String> nameList, ArrayList<Object> iconList, ArrayList<Boolean> checkBoxList) {
        super();
        mNameList = nameList;
        mIconList = iconList;
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(obj instanceof Drawable) {
            ...
            viewTag.mIcon.setImageResource(R.drawable.music_icon);
        }
